package com.example.donow.model;
...
import com.example.donow.data.DoNowRepository;

import java.util.List;

public class TaskViewModel extends AndroidViewModel {
    public static DoNowRepository repository;
    public final LiveData<List<Task>> allTasks;

    public TaskViewModel(@NonNull Application application) {
        super(application);
        repository = new DoNowRepository(application);
